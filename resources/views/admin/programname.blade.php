                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="row">
                             ...
                             <div class="header">
                                <div class="typo-line">
                                    <p class="category">Хөтөлбөрийн нэр байхгүй байна.</p>
                                </div>
                              </div>
                            @else
                                <div class="content table-responsive table-full-width">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $programName->id }}</td>
                                                    <td>{{ $programName->name }}</td>
                                                </tr>
                                                @endforeach
                                        </tbody>
                                    </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                         <form method="POST" action="{{ url('/admin/programname') }}">
                                   <input name="_token" type="hidden" value="{!! csrf_token() !!}" />
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Хөтөлбөрийн нэр:</label>
                                                <input type="text" class="form-control border-input" name='name' placeholder="Хөтөлбөрийн нэр">
                                            </div>
                                        </div>
                                    </div>
