                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="row">
                             ...
                             <div class="header">
                                <div class="typo-line">
                                    <p class="category">Бүртгэлтэй ерөнхийлөгч байхгүй байна.</p>
                                </div>
                              </div>
                            @else
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                         <form method="POST" action="{{ url('/admin/presidents') }}">
                                   <input name="_token" type="hidden" value="{!! csrf_token() !!}" />
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Овог:</label>
                                                <input type="text" class="form-control border-input" name='firstname' placeholder="Овог">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Нэр:</label>
                                                <input type="text" class="form-control border-input" name='lastname' placeholder="Нэр">
                                            </div>
                                        </div>
                                    </div>
